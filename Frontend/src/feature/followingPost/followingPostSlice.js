...
export const getFollowingPosts = createAsyncThunk(
  "http://localhost:8080/api/v1/followingposts",
  async (thunkAPI) => {
    const response = await axios({
      method: "post",
      // mode: "cors",
      url: "http://localhost:8080/api/v1/followingposts",
      headers: {
...
async function updateLove(postId, currentUserId) {
    const response = await axios({
        method: "post",
        url: "http://localhost:8080/api/v1/lovepost",
        headers: {
         Authorization: localStorage.getItem("psnToken"),
        },
        data: {
...
async function updateShare(postId, currentUserId) {
    const response = await axios({
        method: "post",
        url: "http://localhost:8080/api/v1/sharepost",
        headers: {
         Authorization: localStorage.getItem("psnToken"),
        },
        data: {
